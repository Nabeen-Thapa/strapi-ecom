...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attributes: Schema.Attribute.Component<
      'shared.laptop-specifications',
      true
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    discount: Schema.Attribute.Component<'shared.discount', true>;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wish_lists: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    >;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    profileImage: Schema.Attribute.Component<'shared.media', true>;
